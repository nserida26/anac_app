    ...
    <div class="card-body">
        ...
        <form method="POST" id="avionForm"  style="display: none;">
            ...
            <div class="alert alert-info">
                ...
                Saisissez les immatriculations une par une et appuyez sur <kbd>Entrée</kbd> ou <kbd>,</kbd> pour les ajouter.
            </div>
            ...
            <div class="row">
                ...
                <div class="col-md-12 mb-3">
                    <div class="form-group">
                        ...
                        <select class="form-control" id="immatriculations_select" 
                                name="immatriculations[]" multiple="multiple" style="width: 100%; height: 100px;">
                            <!-- Les options seront ajoutées dynamiquement -->
                        </select>
                        <div class="invalid-feedback" id="immatriculations_error"></div>
                        <small class="text-muted">Tapez une immatriculation et appuyez sur Entrée pour l'ajouter</small>
                    </div>
                </div>
            </div>
            ...
            <div class="row">
                ...
                <div class="col-md-6 mb-3">
                    <div class="form-group">
                        <div class="d-flex justify-content-between align-items-center mb-1">
                            <label for="type_avion_id" class="form-label">Type d'avion <span class="text-danger">*</span></label>
                            <button type="button" class="btn btn-sm btn-success" id="addTypeAvionBtn">
                                <i class="fas fa-plus"></i> Ajouter
                            </button>
                        </div>
                        <select class="form-control select2-single" id="type_avion_id" name="type_avion_id" required>
                            <option value="">Sélectionnez un type</option>
                            @foreach ($type_avions as $type)
                                <option value="{{ $type->id }}" data-code="{{ $type->code }}" data-capacite="{{ $type->capacite }}">
                ...
                <div class="col-md-6 mb-3">
                    <div class="form-group">
                        <div class="d-flex justify-content-between align-items-center mb-1">
                            <label for="compagnie_aerienne_id" class="form-label">Opérateur <span class="text-danger">*</span></label>
                    ...
                    <div class="alert alert-success">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                ...
                                <p><strong>Opérateur:</strong> <span id="selectedOperatorDisplay">-</span></p>
                            </div>
                            <div class="col-md-6">
                                <div id="immatriculationsPreview" class="mt-2"></div>
                                <p class="mb-0"><strong>Total:</strong> <span id="totalCount">0</span> avion(s)</p>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    <button type="button" class="btn btn-secondary float-right mr-2" id="cancelAvionFormBtn">
    ...
    <div class="card-body">
        ...
        <form method="POST" id="volForm" style="display: none;">
            ...
            <div class="row">
                ...
                <div class="col-md-6 mb-3">
                    <div class="form-group">
                        <label for="nbr_passagers" id = "nbr_passagers_label" class="form-label">Nombre de passagers</label>
                ...
                <div class="col-lg-3 col-md-3 mb-3">
                    <div class="form-group">
                        <label for="date_depart" class="form-label">Heure départ <span
                                class="text-danger">*</span></label>
                        <input type="time" class="form-control" id="date_depart"
                ...
                <div class="col-lg-3 col-md-4 mb-3">
                    <div class="form-group">
                        <label for="date_arrivee" class="form-label">Heure arrivée <span
                                class="text-danger">*</span></label>
                        <input type="time" class="form-control" id="date_arrivee"
                            name="date_arrivee" required>
                ...
                <div class="col-md-12">
                    <div class="card card-secondary">
                        <div class="card-header">
                            ...
                            <button type="button" class="btn btn-sm btn-success float-right" id="addEscaleBtn">
        ...
        @endif
                                        ...
                                        <table class="table table-striped table-bordered" id="crewTable">
                                            ...
                                            <tbody>
                                                @foreach ($equipe_vols as $membre)
                                                    ...
                                                    <tr id="edit-form-membre-{{ $membre->id }}" style="display: none;">
                                                        <td colspan="6">
                                                            <form id="updateCrewForm-{{ $membre->id }}" method="POST"
                                                                enctype="multipart/form-data">
                                                                @method('PUT')
                                                                @csrf
                ...
                <div class="card card-info mt-4">
                    ...
                    <div class="card-body">
                        {{-- Add MDN Form --}}
                        <form method="POST" id="mdnForm" action="{{ url('/user/mdns') }}" enctype="multipart/form-data">
                            @csrf
                            <input type="hidden" value="{{ $demandeAutorisation->id }}" id="demande_autorisation_id" name="demande_autorisation_id">
                            
                            <div class="row">
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <label for="date_autorisation">@lang('trans.authorization_date') <span class="text-danger">*</span></label>
                                        <input type="date" class="form-control" id="date_autorisation" name="date_autorisation" required>
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <label for="numero_mdn">@lang('trans.mdn_number') <span class="text-danger">*</span></label>
                                        <input type="text" class="form-control" id="numero_mdn" name="numero_mdn" placeholder="" required>
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="form-group">
                                        ...
                                        <tbody>
                                            @foreach ($mdns as $mdn)
                                                <tr id="mdn-{{ $mdn->id }}">
                                                    ...
                                                    <td>
                                                        <button class="btn btn-warning btn-sm edit-mdn" data-id="{{ $mdn->id }}">
                                                            <i class="fas fa-edit"></i> @lang('trans.update')
                                                        </button>
                                                        <button class="btn btn-danger btn-sm delete-mdn" data-id="{{ $mdn->id }}">
                                                            <i class="fas fa-trash"></i> @lang('trans.delete')
                                                        </button>
                                                    </td>
                                                </tr>
                                                <tr id="edit-form-mdn-{{ $mdn->id }}" style="display: none;">
                                                    <td colspan="4">
                                                        <form id="updateMdnForm-{{ $mdn->id }}" method="POST" enctype="multipart/form-data">
                                                            @method('PUT')
                                                            @csrf
                                                            
                                                            <input type="hidden" name="mdn_id" value="{{ $mdn->id }}">
                                                            
                                                            <div class="row">
                                                                <div class="col-md-4">
                                                                    <div class="form-group">
                                                                        <label>@lang('trans.authorization_date')</label>
                                                                        <input type="date" class="form-control" name="date_autorisation" 
                                                                               value="{{ $mdn->date_autorisation ? $mdn->date_autorisation->format('Y-m-d') : '' }}" required>
                                                                    </div>
                                                                </div>
                                                                <div class="col-md-4">
                                                                    <div class="form-group">
                                                                        <label>@lang('trans.mdn_number')</label>
                                                                        <input type="text" class="form-control" name="numero_mdn" 
                                                                               value="{{ $mdn->numero_mdn }}" required>
                                                                    </div>
                                                                </div>
                                                                <div class="col-md-4">
                                                                    <div class="form-group">
                                                            ...
                                                            <button type="submit" class="btn btn-primary btn-sm update-mdn">
                                                                <i class="fas fa-save"></i> @lang('trans.update')
                                                            </button>
                                                            <button type="button" class="btn btn-secondary btn-sm cancel-edit-mdn" data-id="{{ $mdn->id }}">
                                        ...
                                        <table class="table table-striped table-bordered" id="fretTable">
                                            ...
                                            <tbody>
                                                @foreach ($fretVols as $fret)
                                                    ...
                                                    <tr id="edit-form-fret-{{ $fret->id }}" style="display: none;">
                                                        <td colspan="6">
                                        ...
                                        <table class="table table-striped table-bordered" id="partyTable">
                                            ...
                                            <tbody>
                                                @foreach ($receivingParties as $party)
                                                    ...
                                                    <tr id="edit-form-party-{{ $party->id }}" style="display: none;">
                                                        <td colspan="6">
                                                            <form id="updatePartyForm-{{ $party->id }}"
                                                                ...
                                                                <div class="row">
                                                                    <div class="col-md-12">
                                                                        <div class="form-group">
                                                                            <label>Pièce d'identité (Laisser vide pour ne
                                                                                pas
                                                                                changer)</label>
                                                                            <input type="file"
                                                                                class="form-control-file"
                                                                ...
                                                                <button type="submit"
                                                                    ...
                                                                    data-id="{{ $party->id }}">Mettre à jour</button>
                                                                <button type="button"
                                                                    class="btn btn-secondary btn-sm cancel-edit"
                                                                    data-id="{{ $party->id }}"
                    ...
                    <div class="card-body">
                        <form method="POST" id="deceasedPersonForm" action="{{ url('/user/personnes-deces') }}"
                            ...
                            <div class="row">
                                <div class="col-md-4">
                                    <div class="form-group">
                                        <label for="nom_prenom"><span class="text-danger">*</span>@lang('trans.full_name')</label>
                            ...
                            <div class="row">
                                <div class="col-lg-12">
                                    <button id="submitDeceasedPerson" type="submit" class="btn btn-success float-right">
                                        <i class="fas fa-plus"></i> @lang('trans.add')
                                    </button>
                                </div>
                            </div>
                                    ...
                                    <table class="table table-striped table-bordered" id="deceasedPersonsTable">
                                        ...
                                        <tbody>
                                            @foreach ($personnesDeces as $personne)
                                                ...
                                                <tr id="edit-form-personne-{{ $personne->id }}" style="display: none;">
                                                    <td colspan="4">
                                                        <form id="updateDeceasedPersonForm-{{ $personne->id }}" method="POST"
                                                            enctype="multipart/form-data">
                                                            @method('PUT')
                                                            @csrf
                                                            ...
                                                            <div class="row">
                                                                <div class="col-md-4">
                                                                    <div class="form-group">
                                                                        ...
                                                                        <input type="text" class="form-control"
                                                                            name="nom_prenom"
                                                                            value="{{ $personne->nom_prenom }}" required>
                                                                    </div>
                                                                </div>
                                                                <div class="col-md-4">
                                                                    <div class="form-group">
                                                                    ...
                                                                    <div class="form-group">
                                                                        ...
                                                                        @if($personne->justificatif)
                                                                            <small class="form-text text-muted">
                                                                                @lang('trans.current_file'): {{ $personne->justificatif }}
                                                                            </small>
                                                                        @endif
                                                                    </div>
                                                                </div>
                                                            ...
                                                            <button type="button"
                                                                class="btn btn-secondary btn-sm cancel-edit"
                                                                data-id="{{ $personne->id }}" data-type="personne">
                                                                @lang('trans.cancel')
                                                            </button>
                                                        </form>
                                                    </td>
                                ...
                                @foreach ($requiredDocs as $index => $requiredDoc)
                                    ...
                                    <li class="mb-3">
                                        ...
                                        <div class="input-group">
                                            ...
                                            @if($existingDoc)
                                                <input type="hidden" name="existing_document_ids[]" value="{{ $existingDoc->id }}">
                                            @endif
                                        </div>
                                        <small class="form-text text-muted">
                ...
                <div class="modal-body">
                    ...
                    <form id="replaceDocumentForm" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <input type="file" class="form-control" id="replace_piece" 
                                   name="piece" accept="application/pdf" required>
                        </div>
                    </form>
                </div>
            ...
            <div class="modal-body">
                <form id="typeAvionForm">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="number" class="form-control" id="charge_max" name="charge_max" min="0" value="0">
                    </div>
                </form>
            </div>
            <div class="modal-footer">
...
// Déclarer les aéroports en JavaScript
        const aeroports = @json($aeroports->map(function($aeroport) {
            return [
                'id' => $aeroport->id,
    ...
    function getEscaleTemplate(counter, escaleData = null) {
        ...
        if (typeof aeroports !== 'undefined') {
            aeroports.forEach(aeroport => {
                ...
                options += `<option value="${aeroport.id}" ${selected}>${aeroport.codeICAO}</option>`;
            });
        }
...
$('#volForm').submit(function(e) {
    ...
    $.ajax({
        ...
        beforeSend: function() {
            $('#submitVolBtn').prop('disabled', true).html('<i class="fas fa-spinner fa-spin"></i> Enregistrement...');
        },
        success: function(response) {
        ...
        error: function(xhr) {
            ...
            if (xhr.status === 419) {
                toastr.error('Session expirée. Veuillez rafraîchir la page et réessayer.');
                setTimeout(() => {
                    location.reload();
                }, 2000);
        ...
        complete: function() {
            $('#submitVolBtn').prop('disabled', false).html('<i class="fas fa-save"></i> ' + $('#volFormAction').text());
        }
    });
    ...
    Swal.fire({
        ...
        if (result.isConfirmed) {
            $.ajax({
                ...
                success: function() {
                    $(`#personne-${id}, #edit-form-personne-${id}`).remove();
...
$('#confirmReplace').click(function() {
    ...
    $(this).prop('disabled', true).html('<i class="fas fa-spinner fa-spin"></i> Remplacement...');
                ...
                success: function(response) {
                    row.fadeOut(400, function() {
                        ...
                        if ($('#documentsTable tbody tr').length === 0) {
                            $('#documentsTable').closest('.table-responsive').remove();
                            $('#documentsTable').after('<div class="alert alert-info mt-3">Aucun document n\'a été uploadé pour cette demande.</div>');
                        }
                    });
