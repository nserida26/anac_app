...
<button class="navbar-toggler order-1" type="button" data-toggle="collapse"
    ...
    <span class="navbar-toggler-icon"></span>
            ...
            @if (auth()->user()->hasRole('dsv'))
                <a href="{{ route('dsv') }}" class="navbar-brand">
            ...
            @if (auth()->user()->hasRole('dg'))
                <a href="{{ route('dg') }}" class="navbar-brand">
                    <img src="{{ asset('assets/admin/imgs/logo.png') }}" alt="ANAC Logo"
                        class="brand-image img-circle elevation-3" style="opacity: .8">
                    <span class="brand-text font-weight-light">ANAC</span>
                </a>
            ...
            @if (auth()->user()->hasRole('dta'))
                <a href="{{ route('dta') }}" class="navbar-brand">
                    <img src="{{ asset('assets/admin/imgs/logo.png') }}" alt="ANAC Logo"
                        class="brand-image img-circle elevation-3" style="opacity: .8">
                    <span class="brand-text font-weight-light">ANAC</span>
                </a>
            ...
            @if (auth()->user()->hasRole('dsna'))
                <a href="{{ route('dsna') }}" class="navbar-brand">
                    <img src="{{ asset('assets/admin/imgs/logo.png') }}" alt="ANAC Logo"
                        class="brand-image img-circle elevation-3" style="opacity: .8">
                    <span class="brand-text font-weight-light">ANAC</span>
                </a>
            ...
            @if (auth()->user()->hasRole('dsad'))
                <a href="{{ route('dsad') }}" class="navbar-brand">
                    <img src="{{ asset('assets/admin/imgs/logo.png') }}" alt="ANAC Logo"
                        class="brand-image img-circle elevation-3" style="opacity: .8">
                    <span class="brand-text font-weight-light">ANAC</span>
                </a>
            ...
            <div class="collapse navbar-collapse order-3" id="navbarCollapse">
                <!-- Left navbar links -->
                <ul class="navbar-nav">
                    @if (auth()->user()->hasRole('dg') || auth()->user()->hasRole('dsv'))
                        <li class="nav-item">
                            <a href="{{ route('dir.licences') }}" class="nav-link">@lang('trans.licences')</a>
                        </li>
                        <li class="nav-item">
                            <a href="{{ route('dir.demandeLicences') }}" class="nav-link">@lang('trans.license_applications')</a>
                        </li>
                    @endif
                    <li class="nav-item">
                        <a href="{{ route('dir.demandeAutorisations') }}" class="nav-link">@lang('trans.autorization_applications')</a>
                    </li>
                    <li class="nav-item">
                        <a href="{{ route('dir.demandeApprobations') }}" class="nav-link">@lang('trans.approbation_applications')</a>
                    </li>
            ...
            <ul class="order-1 order-md-3 navbar-nav navbar-no-expand ml-auto">
                ...
                <li class="nav-item dropdown no-arrow">
                    ...
                    <div class="dropdown-menu dropdown-menu-right shadow animated--grow-in"
                        ...
                        @if (auth()->user()->hasRole('dg') || auth()->user()->hasRole('dsv') || auth()->user()->hasRole('dta'))
                            <a class="dropdown-item" href="{{ route('dir.sc') }}">
