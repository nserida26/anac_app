...
@push('script')
    ...
    <script>
        ...
        // Fonction pour ouvrir le modal de décision (plusieurs éléments d'une même section)
        ...
        // Fonction pour ouvrir le modal de décision (éléments sélectionnés dans plusieurs sections à la fois)
