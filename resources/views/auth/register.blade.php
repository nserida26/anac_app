            ...
            <div class="card-body register-card-body">
                ...
                <form action="{{ route('register') }}" method="post">
                    ...
                    <div class="form-group mb-3">
                        <select name="country_code" class="form-control select2" id="country_code">
                            <option selected="selected" data-countryCode="MR" value="222">Mauritania (+222)</option>
                    ...
                    <div class="input-group mb-3">
                        <input type="password" name="password" class="form-control"
                            placeholder={{ __('register.password') }} autocomplete="new-password" required>
                        <div class="input-group-append">
                            <div class="input-group-text">
                    ...
                    <div class="input-group mb-3">
                        ...
                        <select name="user_type" id="user_type"
                            ...
                            placeholder={{ __('register.user_type') }} required>
                            <option value="">-- Sélectionnez --</option>
                            <option value="autorisation" {{ old('user_type') == 'autorisation' ? 'selected' : '' }}>
                                Demandeur d'autorisation</option>
                            <option value="licence" {{ old('user_type') == 'licence' ? 'selected' : '' }}>Demandeur de
                                licence</option>
                        </select>
                        @error('user_type')
                    ...
                    <div class="row">
                        ...
                        <div class="col-12">
                            <button type="submit"
                                class="btn btn-primary btn-block btn-flat">@lang('register.enter')</button>
                        </div>
                        <!-- /.col -->
                    </div>
                </form>
